...
import java.util.List;
    ...
    public class FirstAvailableAdapter extends RecyclerView.Adapter<com.joor.roomapplication.adapters.ReservationAdapter.ViewHolder> {
        ...
        public FirstAvailableAdapter(Activity activity, List<Reservation> reservations){
        ...
        @Override
        public com.joor.roomapplication.adapters.ReservationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
            //create new view
            convertView = (View) LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_layout, parent, false);
            com.joor.roomapplication.adapters.ReservationAdapter.ViewHolder vh = new com.joor.roomapplication.adapters.ReservationAdapter.ViewHolder(convertView);
            return vh;
        }
